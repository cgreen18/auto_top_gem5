...
class GPUFS_NoCI_EscapeVirtualNetworks(SimpleTopology):
    description='GPUFS_NoCI_EscapeVirtualNetworks'
    ...
    def makeTopology(self, options, network, IntLink, ExtLink, Router):
        ...
        print(f'traceback.format_stack()={traceback.format_stack()}')
                ...
                if(is_connected >= 1):
                    ...
                    if src_r < n_noi_routers:
                        ...
                        # noi -> noc
                            ...
                            # print(f'Adding noi->noc internal link (id {link_count}) {src_r}->{dest_r}')
                    ...
                    # src noc
                        ...
                        # noc -> noi
                        if dest_r < n_noi_routers:
                            # print(f'Adding noc->noi internal link (id {link_count}) {src_r}->{dest_r}')
                            #  | (noc_domain) noc router <----out_link,in_link--->| CDC (noi domain) noi router |
                            int_links.append(IntLink(link_id=link_count,
                                        src_node=routers[src_r],
                                        dst_node=routers[dest_r],
