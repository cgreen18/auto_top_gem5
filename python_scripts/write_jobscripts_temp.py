...
def write_jobscript(n_inst, n_warmup_inst, topology, alg_type, lb_type, benchmark, cpu_clk, l2_size, nreps=None, n_evns=None, is_picky=False, use_simple=False, n_l2s=64, all_threads=True,n_vcs=10,link_width=128,rlat=1, moesi=False):
    ...
    cmd += ' --num-cpus 64 --mem_or_coh mem --num-dirs 32'
                        ...
                        for l2s in l2_sizes:
                            for if_simple in cpu_types:
                                for lw in link_widths:
                                    ...
                                    write_jobscript(n_inst, n_warmup, topo, alg, lb, bench, cf, l2s, n_evns=evns, nreps=reps, is_picky=is_picky, use_simple=if_simple, n_l2s=n_l2s,n_vcs=n_vcs,link_width=lw,rlat=rlat, moesi=use_moesi)
                                    i+=1
