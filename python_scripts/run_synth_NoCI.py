...
class BenchmarkRun:
    ...
    def __init__(self, map_file, memcoh, sim_cycle, inj_rate, hetero, alg_type, lb_type):
        ...
        vn_file = f'{self.topology}_{alg_type}_{lb_type}.vn'
                ...
                for sf in map_files:
                    for a_t in alg_types:
                        for lb_t in lb_types:
                            ...
                            runs += [BenchmarkRun(sf, mc, sim_cycle, ir, het, a_t, lb_t)]
                            i+=1
